...
def build_model(x_adj, learning_rate):
    ...
    model.add(LSTM(100,
                   ...
                   recurrent_regularizer=reg.L1(0.005),
                   kernel_regularizer=reg.L1(0.005)))   # recurrent_dropout=0.05))
    model.add(BatchNormalization())
    model.add(Dropout(0.05))

    # second layer
    # model.add(LSTM(40, return_sequences=True,))# kernel_regularizer=reg.L1(0.001)))
    # model.add(BatchNormalization())
    # model.add(Dropout(0.05))
    model.add(LSTM(100, return_sequences=False, recurrent_regularizer=reg.L1(0.005), kernel_regularizer=reg.L1(0.005)))
    model.add(BatchNormalization())
    model.add(Dropout(0.05))
